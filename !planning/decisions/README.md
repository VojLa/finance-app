...
| ADR | Nazev | Status |
| --- | --- | --- |
| `0001-python-backend.md` | Python jako primarni backend | Accepted |
| `0002-postgresql.md` | PostgreSQL jako hlavni databaze | Accepted |
| `0003-modular-monolith.md` | Modularni monolit jako vychozi backendova architektura | Accepted |
| `0004-read-models.md` | Oddeleni read modelu od canonical historie | Accepted |
