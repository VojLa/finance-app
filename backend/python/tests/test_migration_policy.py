...
def test_workflow_policy_requires_restricted_archive_wrapper(
    ...
    workflow.write_text(
        ...
        "run: python scripts/database_schema.py --check --revision 3h0001twdata\n"
        "run: python scripts/database_schema.py --check --revision 3h0001twdata\n",
        encoding="utf-8",
    )
