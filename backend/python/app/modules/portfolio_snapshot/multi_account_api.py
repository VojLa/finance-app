"""Thin HTTP adapter for an authorized exact multi-account portfolio snapshot."""
...
def get_authorized_multi_account_portfolio_snapshot_service(
    ...
    return AuthorizedMultiAccountPortfolioSnapshotService(session)


@router.post(
    "/snapshot",
    response_model=MultiAccountPortfolioResponse,
    response_model_by_alias=True,
)
async def read_multi_account_portfolio_snapshot(
    request: ExactPortfolioSnapshotSetRequest,
    principal: CurrentPrincipal,
    service: Annotated[
        AuthorizedMultiAccountPortfolioSnapshotService,
        Depends(get_authorized_multi_account_portfolio_snapshot_service),
    ],
) -> MultiAccountPortfolioResponse:
