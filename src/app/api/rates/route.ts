...
import { getLivePrices, clearPriceCache, getCzkRates } from "@/lib/rates"

// GET /api/rates?refresh=true
// Vrátí aktuální ceny všech holdings uživatele.
// ?refresh=true přeskočí cache a stáhne čerstvá data.
